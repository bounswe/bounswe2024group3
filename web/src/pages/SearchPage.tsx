              ...
              <>
                  {spotifyResults.tracks && (
                      <div className="mb-8">
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                              {spotifyResults.tracks.map((track: SearchResult) => (
                                  <Link 
                                      to={`/track/${track.id}`}
                                      key={track.id}
                  ...
                  {spotifyResults.albums && (
                      <div className="mb-8">
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                              {spotifyResults.albums.map((album: SearchResult) => (
                                  <Link 
                                      to={`/album/${album.id}`}
                                      key={album.id}
                                      className="block hover:no-underline"
                  ...
                  {spotifyResults.artists && (
                      <div className="mb-8">
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                              {spotifyResults.artists.map((artist: SearchResult) => (
                                  <Link 
                                      to={`/artist/${artist.id}`}
                                      key={artist.id}
                                      className="block hover:no-underline"
          ...
          <div className="space-y-8">
              ...
              {contents.length > 0 && (
                  <div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                          {contents
                              .filter((content: PostContent) => activeTab === 'all' || content.content_type === activeTab)
