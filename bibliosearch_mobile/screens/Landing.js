    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.numberone}>
                <Text style={styles.numberoneText}>#1 Semantic Book Browsing App</Text>
            </View>
            ...
            <View style={styles.numberone}>
                <Text style={styles.numberoneText}>Or don't have an account yet?</Text>
            </View>
...
const styles = StyleSheet.create({
    ...
    numberoneText: {
        marginLeft: 20,
        fontSize: 20, // Larger text for the app name
        fontWeight: 'bold',
        color: 'white',
    },
    button: {
